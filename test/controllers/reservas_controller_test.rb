...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { data_entrada: @reserva.data_entrada, data_saida: @reserva.data_saida, hora_entrada: @reserva.hora_entrada, hora_saida: @reserva.hora_saida } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data_entrada: @reserva.data_entrada, data_saida: @reserva.data_saida, hora_entrada: @reserva.hora_entrada, hora_saida: @reserva.hora_saida } }
