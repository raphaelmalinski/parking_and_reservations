...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { ano: @veiculo.ano, marca: @veiculo.marca, modelo: @veiculo.modelo, placa: @veiculo.placa } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { ano: @veiculo.ano, marca: @veiculo.marca, modelo: @veiculo.modelo, placa: @veiculo.placa } }
